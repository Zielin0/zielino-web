  ...
  return (
    <>
      ...
      <div className="main-container">
        ...
        <p className="about-p">
          {t('welcome_message_primary')}{' '}
          <a href="https://github.com/Zielin0/">Zielino</a>{' '}
          {t('welcome_message_secondary')}
        </p>
        ...
        <p className="about-p">
          {t('frameworks')} <a href="https://nodejs.org/">Node.js</a> {t('and')}{' '}
          <a href="https://github.com/facebook/react/">React.js</a>
        </p>
        <p className="about-p">
          {t('package_manager_primary')}{' '}
          <a href="https://github.com/yarnpkg/yarn/">yarn</a>{' '}
          {t('package_manager_secondary')}
        </p>
